...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
        ...
        <div class="dashboard-heading">
            <h2 class="dashboard-title">Data Pembayaran Pasien <?= session()->nama ?></h2>
                                ...
                                <div class="col-12 mt-3">
                                    <div class="col-md-10">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-7">
                                                <form id="metode_id" action="<?= base_url() ?>laporan/pasien/m_add" method="POST">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input tunai" type="radio" name="inlineRadioOptions" <?php if ($periksa->id_pembayaran == 2) {
                                                                                                                                            echo 'checked';
                                                    ...
                                                    <div class="form-check form-check-inline ml-5">
                                                        <input class="form-check-input non-tunai" type="radio" name="inlineRadioOptions" <?php if ($periksa->id_pembayaran == 3) {
                                                                                                                                                echo 'checked';
