            ...
            <div class="row mt-3">
                ...
                <div class="col-12 mb-4 table-dashboard">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" method="post" action="<?= base_url() ?>/booking/edit/<?= $d['id_booking']; ?>" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group time mt-2">
                                            <input type="text" id="timepicker1" name="untuk_jam" class="form-control" value="<?= $d['untuk_jam'] ?>" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group date mt-2">
                                            <input type="text" class="form-control" id="datepicker" placeholder="Hari/Bulan/Tahun" name="untuk_tanggal" value="<?= $d['untuk_tanggal'] ?>"required>
