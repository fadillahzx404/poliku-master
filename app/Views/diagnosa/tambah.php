...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
        <div class="dashboard-heading">
            <h2 class="dashboard-title">Tambah Data Diagnosa Baru</h2>
            <p class="dashboard-subtitle">
                Silakan isi data diagnosa di bawah ini, untuk menambahkan diagnosa baru.
            </p>
        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 mb-4 table-dashboard">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" method="post" action="<?= base_url() ?>diagnosa/tambah" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom002">Nama Diagnosa</label>
