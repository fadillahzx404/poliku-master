...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
        <div class="dashboard-heading">
            <h2 class="dashboard-title">Tambah Data Pasien Baru</h2>
            <p class="dashboard-subtitle">
                Silakan isi data pasien di bawah ini, untuk menambahkan pasien.
            </p>
        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 mb-4 table-dashboard">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" method="post" action="<?= base_url() ?>/pasien/tambah" enctype="multipart/form-data">
                                <div class="row">
